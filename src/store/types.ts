...
export const START_EDIT_INGREDIENT =
  '[companyName]/shoppinglist-START_EDIT_INGREDIENT';
export const STOP_EDIT_INGREDIENT =
  '[companyName]/shoppinglist-STOP_EDIT_INGREDIENT';
